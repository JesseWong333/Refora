...
describe('moveToLibrary', () => {
  ...
  it('appends (1) suffix on first collision', () => {
    ...
    expect(mockExistsSync).toHaveBeenNthCalledWith(1, '/library')
    expect(mockExistsSync).toHaveBeenNthCalledWith(2, '/library/doc.pdf')
    expect(mockExistsSync).toHaveBeenNthCalledWith(3, '/library/doc (1).pdf')
